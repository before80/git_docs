...
Git can also be used in a CVS-like mode, with a central repository that various users push changes to; see [git-push[1]](../../1/git-push) and [gitcvs-migration[7]](../gitcvs-migration).
